        ...
        <div class="wrapper-container thanks-page">
            <div class="card thank-card">
                <div class="card-body text-center ">
                    ...
                    <h4 class="text-wrap text-white">ধন্যবাদ অর্ডার করার জন্য 😊 খুব শীঘ্রই আপনার সাথে যোগাযোগ করা হবে। অথবা যেকোনো
                        প্রয়োজনে কল করুন {{ $site_contact_info->phone }}</h4>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        dataLayer.push({
            ...
            ecommerce: {
                ...
                value: "{{ $order->total }}",
                shipping: "{{ $orders->shipping->price }}",
                currency: "BDT",
                items: [
                    @foreach ($orders->orderItem as $order)
                        {
