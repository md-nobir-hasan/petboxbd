                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body" id="cart_product">
                            <form action="">
                                ...
                                @endphp
                                @forelse ($wishlists as $cart_product)
                                    @php
                                            ...
                                            <div class="card">
                                                <div class="card-body position-relative">
                                                    ...
                                                    <div class="d-flex justify-content-around text-start">
                                                        ...
                                                        @php
                                                            $price = ($cart_product->product->price - $cart_product->product->discount) * $cart_product->qty;
                                                        @endphp
                                                        <div class="cart-text">
                                                            <span class="d-block">BD ৳ <input class="real-price w4digit"
                                                                    id="{{ $cart_product->product->price }}"
                                                                    value="{{ $cart_product->product->price }}"
                                                                    name="order_item[{{ $cart_product->product->id }}][price]"></span>
