                                ...
                                <form method="post" action="{{ route('page.update',[$page->id]) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputTitle" type="text" name="title" placeholder="Enter Page Title"
                                            value="{{$page->title ?? old('title') }}" class="form-control">
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        <label for="page_design" class="col-form-label">Page Design <span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control summernote" id="page_design" name="page_design">{{$page->page_design ?? old('page_design') }}</textarea>
                                        @error('page_design')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
